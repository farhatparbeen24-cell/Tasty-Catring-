    ...
    <div className="flex flex-col min-h-screen selection:bg-brand-primary/10 selection:text-brand-primary">
      ...
      <div className="fixed bottom-8 right-8 z-50 flex flex-col gap-4">
        <a 
          ...
          className="bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:scale-110 transition-transform duration-300 flex items-center justify-center group relative cursor-pointer"
          aria-label="Contact on WhatsApp"
        >
          {/* Professional WhatsApp SVG Path */}
          <svg 
            width="28" 
            height="28" 
            viewBox="0 0 24 24" 
